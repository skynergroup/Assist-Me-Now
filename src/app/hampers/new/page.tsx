...
const NewHamperPage: React.FC = () => {
  ...
  const onSubmit = async (data: HamperFormData) => {
    ...
    try {
      ...
      const response = await api.hampers.create(hamperData);

      if (response.success) {
        router.push('/hampers');
      } else {
        setError(response.error || 'Failed to create hamper');
      }
    } catch (err) {
      console.error('Error creating hamper:', err);
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-semibold text-gray-900">Add New Hamper</h1>
          <button
            onClick={() => router.back()}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Enter the basic details for this hamper.
              </p>
            </div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Add items to include in this hamper.
              </p>
            </div>
            <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
