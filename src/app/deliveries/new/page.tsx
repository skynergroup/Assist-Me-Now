...
import { DeliveryStatus, Hamper, Recipient } from '@/types';
...
const NewDeliveryPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError('Failed to load hampers and recipients');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const onSubmit = async (data: DeliveryFormData) => {
    ...
    try {
      ...
      const response = await api.deliveries.create(deliveryData);
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-semibold text-gray-900">Add New Delivery</h1>
          <button
            onClick={() => router.back()}
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Enter the details for this delivery.
              </p>
            </div>
